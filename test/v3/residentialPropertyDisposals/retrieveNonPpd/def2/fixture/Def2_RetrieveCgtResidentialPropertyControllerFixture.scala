...
import v3.residentialPropertyDisposals.retrieveNonPpd.def2.model.response.ClaimOrElectionCodes.{BAD, GHO}

object Def2_RetrieveCgtResidentialPropertyControllerFixture {
  ...
  val responseModel: Def2_RetrieveCgtResidentialPropertyResponse =
    Def2_RetrieveCgtResidentialPropertyResponse(
