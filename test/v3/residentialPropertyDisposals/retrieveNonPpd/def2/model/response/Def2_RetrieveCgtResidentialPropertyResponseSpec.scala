...
class Def2_RetrieveCgtResidentialPropertyResponseSpec extends UnitSpec {

  "Def2_RetrieveCgtResidentialPropertyResponse" when {
    "Reads" should {
      "return a valid object" when {
        "a valid json is supplied" in {
          downstreamJson.as[Def2_RetrieveCgtResidentialPropertyResponse] shouldBe responseModel
        }
      }
    }
