...
trait MockRetrieveCgtPpdOverridesConnector extends TestSuite with MockFactory {

  val mockRetrieveCgtPpdOverridesConnector: RetrieveCgtPpdOverridesConnector =
    mock[RetrieveCgtPpdOverridesConnector]

  object MockRetrieveCgtPpdOverridesConnector {

    def retrieve(requestData: RetrieveCgtPpdOverridesRequestData): CallHandler[Future[DownstreamOutcome[RetrieveCgtPpdOverridesResponse]]] =
      (
