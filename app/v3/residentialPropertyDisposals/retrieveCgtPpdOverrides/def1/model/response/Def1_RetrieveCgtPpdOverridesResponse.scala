...
case class Def1_RetrieveCgtPpdOverridesResponse(ppdYearToDate: Option[BigDecimal],
...
object Def1_RetrieveCgtPpdOverridesResponse {

  implicit val reads: Reads[Def1_RetrieveCgtPpdOverridesResponse] = (
  ...
  )(Def1_RetrieveCgtPpdOverridesResponse.apply)

  implicit val writes: OWrites[Def1_RetrieveCgtPpdOverridesResponse] = Json.writes[Def1_RetrieveCgtPpdOverridesResponse]
