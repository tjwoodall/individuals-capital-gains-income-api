...
package v3.residentialPropertyDisposals.retrieveAll.def1.model.request

import shared.models.domain.{Nino, TaxYear}
import v3.residentialPropertyDisposals.retrieveAll.RetrieveAllResidentialPropertyCgtSchema
