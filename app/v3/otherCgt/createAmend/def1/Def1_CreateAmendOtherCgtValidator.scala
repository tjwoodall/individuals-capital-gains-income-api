...
import v3.otherCgt.createAmend.def1.Def1_CreateAmendOtherCgtRulesValidator.validateBusinessRules
...
class Def1_CreateAmendOtherCgtValidator(nino: String, taxYear: String, body: JsValue) extends Validator[CreateAmendOtherCgtRequestData] {
  ...
  def validate: Validated[Seq[MtdError], CreateAmendOtherCgtRequestData] =
    (
      ...
      Def1_CreateAmendOtherCgtRequestData(validNino, TaxYear.fromMtd(taxYear), validBody)) andThen validateBusinessRules
